...
export type ResearchEvent = { type: "phase_start"; phase: Phase } | { type: "tool_call"; phase: Phase; call_id: string; tool: string; detail: string } | { type: "tool_result"; phase: Phase; call_id: string } | { type: "tool_error"; phase: Phase; call_id: string; message: string } | { type: "phase_end"; phase: Phase } | { type: "final"; report: string } | { type: "error"; message: string } | { type: "done" } | { type: "heartbeat" };
